class QueryResultsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @query_result.save
        ...
        format.json { render :show, status: :created, location: @query_result }
      else
  ...
  def update
    respond_to do |format|
      if @query_result.update(query_result_params)
        ...
        format.json { render :show, status: :ok, location: @query_result }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to query_results_url, notice: 'Query result was successfully destroyed.' }
  ...
  private
    ...
    def query_result_params
      params.require(:query_result).permit(:query_id, :position, :previous_position, :last_updated)
    end
end
