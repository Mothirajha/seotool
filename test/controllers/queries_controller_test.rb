...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { campaign_id: @query.campaign_id, keyword: @query.keyword, search_engine_id: @query.search_engine_id }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { campaign_id: @query.campaign_id, keyword: @query.keyword, search_engine_id: @query.search_engine_id }
    assert_redirected_to query_path(assigns(:query))
  end
