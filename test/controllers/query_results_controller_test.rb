...
class QueryResultsControllerTest < ActionController::TestCase
  ...
  test "should create query_result" do
    assert_difference('QueryResult.count') do
      post :create, query_result: { last_updated: @query_result.last_updated, position: @query_result.position, previous_position: @query_result.previous_position, query_id: @query_result.query_id }
    end
  ...
  test "should update query_result" do
    patch :update, id: @query_result, query_result: { last_updated: @query_result.last_updated, position: @query_result.position, previous_position: @query_result.previous_position, query_id: @query_result.query_id }
    assert_redirected_to query_result_path(assigns(:query_result))
  end
