...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { domain_id: @keyword.domain_id, search_engine_id: @keyword.search_engine_id, word: @keyword.word }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { domain_id: @keyword.domain_id, search_engine_id: @keyword.search_engine_id, word: @keyword.word }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
